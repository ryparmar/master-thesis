...
from colbert.training.utils import print_progress, manage_checkpoints, save_checkpoint
...
def train(args):
    ...
    if args.resume:
        ...
        start_batch_idx = checkpoint['batch']  # comment if you 
    ...
    # save
    name = os.path.join(Run.path, 'checkpoints', "colbert.dnn")
    save_checkpoint(name, 0, batch_idx, colbert, optimizer, args.input_arguments.__dict__)
